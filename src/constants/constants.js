export const projects = [
  ...
  },
  {
    ...
    description:"A web app that uses fine-tuned GPT to generate a personalized professional emails based on user input. The app also uses a NodeJS backend to handle user requests and a React frontend to display the response.",
